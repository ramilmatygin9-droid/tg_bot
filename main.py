...
# --- ЭЛЕМЕНТЫ ДИЗАЙНА ИЗ ТВОИХ ФОТО ---
DOTS = ". . . . . . . . . . . . . . . . . . ."
LINE = "────────────────"
...
async def play_game(call: types.CallbackQuery):
    ...
    await call.message.delete() # Удаляем меню перед анимацией

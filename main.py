...
def main_kb():
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="🏦 Банк", url="https://t.me/your_bot_link")], # Твоя ссылка на сайт с банком
...
async def prepare_game(call: types.CallbackQuery):
    ...
    # ... (Остальные игры: футбол, баскет и т.д. без изменений)
